...
/**
 * 500 inside the signed-in console. The sidebar is already mounted, so this
 * only needs the content area. reset() is the primary action — most 500s
 * here are transient database connection issues that resolve on retry.
 */
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-24">
      ...
      <p className="mt-4 max-w-[58ch] text-[15px] leading-relaxed text-muted text-pretty">
        The fault is on our side, not with anything you were doing. Nothing you
        had in progress was lost — trying again is usually enough.
      </p>
