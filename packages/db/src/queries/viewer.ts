 ...
 * Postgres over DATABASE_URL as the database owner, which bypasses row-level
 * security entirely. A lot of projects assume RLS is protecting them while
 * their ORM walks straight past it.
 *
